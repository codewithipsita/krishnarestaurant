...
<!-- Mirrored from lionsclubbls.org/gallery/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:52:05 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<title>Welcome to the Official Website of Lions Club Balasore   |  Galleries</title>
...
<!--Meta OG properties-->
<meta property='og:title'  content="Welcome to the Official Website of Lions Club Balasore   |  Galleries"/>
...
<meta property="og:description" content="Welcome to the Official Website of Lions Club Balasore   |  Galleries"/>
...
<link rel="alternate" type="application/rss+xml" title="Lions Club Balasore &raquo; Galleries Feed" href="feed/index.php" />
...
<!-- end Home Slider -->
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-12 col-sm-12">
                                    	<div class="iq_professional_services principal">                                        	
                                            ...
                                            <a class="iq_link_1" href="blanket-distribution/index.php">Read More</a>
                                        </div>
                                    </div>                                 
                                </div>
                            	<!--Heading Wrap Start-->
        ...
        <section class="iq_gallery_bg">
            ...
            <div class="load-more">
                <a class="iq_link_1" href="blood-donation-camp/index.php">LOAD MORE</a>
            </div>
        </section>  
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="iq_info_wrap">
                                <h5><a href="blood-donation-camp/index.php">Generic<br/>Notice</a></h5>
                            </div>
                        </li>
                        <li>
                            <i class=" fa fa-pencil-square-o"></i>
                            <div class="iq_info_wrap">
                                <h5><a href="blood-donation-camp/index.php">Examination<br/>Notice</a></h5>
                            </div>
                        </li>
                        <li>
                            <i class="fa fa-rupee"></i>
                           <div class="iq_info_wrap">
                                <h5><a href="blood-donation-camp/index.php">Tender/Quotation<br/>Notice</a></h5>
                            </div>
                        </li>
                    </ul>
                </div> 
