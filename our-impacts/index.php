...
<!-- Mirrored from lionsclubbls.org/our-impacts/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:50:40 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<title>Welcome to the Official Website of Lions Club Balasore   |  Our Impacts</title>
...
<!--Meta OG properties-->
<meta property='og:title'  content="Welcome to the Official Website of Lions Club Balasore   |  Our Impacts"/>
...
<meta property="og:description" content="Welcome to the Official Website of Lions Club Balasore   |  Our Impacts"/>
...
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="../wp-json/oembed/1.0/embed0e1d.json?url=https%3A%2F%2Flionsclubbls.org%2Four-impacts%2F" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="../wp-json/oembed/1.0/embedc68d?url=https%3A%2F%2Flionsclubbls.org%2Four-impacts%2F&amp;format=xml" />
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/238.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.html?rsd" />
<meta name="generator" content="WordPress 7.0" />
<link rel="canonical" href="index.php" />
<link rel='shortlink' href='../index3dc6.html?p=238' />
...
<ul class="sub-menu">
	...
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-238 current_page_item menu-item-246"><a href="index.php" aria-current="page">Our Impacts</a></li>
...
<!--Header Wrap End-->
    ...
    <section id="content" class="ourevent-sec">
        <div class="container ftco-animate fadeInUp ftco-animated">
            <div class="row">
                <div class="col-md-12 col-lg-12 description">
                    ...
                    <article>
                            <section class="ispl-hero-wrap" style="background: -webkit-linear-gradient(to right, rgba(13,34,64,0.9) 0, rgba(13,34,64,0.1) 100%), url('../wp-content/uploads/2025/08/impacts.jpg');background: linear-gradient(to right, rgba(13,34,64,0.9) 0, rgba(13,34,64,0.1) 100%), url('../wp-content/uploads/2025/08/impacts.jpg'); ">
            ...
            <div class="ispl-hero-inner" style="position:relative; max-width:1120px; margin:0 auto; padding:6rem 1.25rem;">
                                    <h2 style="font-size:3rem; line-height:1.1; margin:0 0 1rem;">Our Impacts – Changing Lives, Strengthening Communities</h2>
                                                    <p style="font-size:1.125rem; max-width:800px;">“The true measure of our service is not in numbers, but in the lives we touch and the hope we inspire. At the Lions Club of Balasore, every initiative, every project, and every act of kindness leaves behind a lasting impact. From bringing sight to the blind and food to the hungry, to empowering youth, uplifting families, and protecting our environment—we work tirelessly to make a difference where it matters most. Our impacts are more than statistics; they are stories of resilience, compassion, and transformation. Each life touched is a reminder that when we serve together, even the smallest effort can create ripples of change that reach far beyond what we can see. This is our legacy, this is our purpose—building a brighter, stronger, and more compassionate world.”</p>
        ...
        <div class="ispl-impacts-filter">
            <select id="lionistic_year">
                <option value="">All Lionistic Years</option>
                <option value="2023-2024">2023-2024</option><option value="2024-2025">2024-2025</option>            </select>

            <select id="global_cause">
                <option value="">All Global Causes</option>
                <option value="building-the-youth">Building the Youth</option><option value="childhood-cancer">Childhood Cancer</option><option value="vision">Vision</option>            </select>

            <!--<button id="ispl-filter-btn">Filter</button>-->
        </div>

        <div id="ispl-impacts-grid"></div>
        <button id="ispl-load-more" data-page="1" style="display:none;">Load More</button>
...
<!-- Mirrored from lionsclubbls.org/our-impacts/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:50:41 GMT -->
</html>