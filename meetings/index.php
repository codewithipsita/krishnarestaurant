...
<!-- Mirrored from lionsclubbls.org/meetings/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:52:10 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<title>Welcome to the Official Website of Lions Club Balasore   |  Meetings</title>
...
<!--Meta OG properties-->
<meta property='og:title'  content="Welcome to the Official Website of Lions Club Balasore   |  Meetings"/>
...
<meta property="og:description" content="Welcome to the Official Website of Lions Club Balasore   |  Meetings"/>
...
<link rel="alternate" type="application/rss+xml" title="Lions Club Balasore &raquo; Meetings Feed" href="feed/index.php" />
...
<!-- end Home Slider -->
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-12 col-sm-12">
                                    	<div class="iq_professional_services principal">                                        	
                                            ...
                                            <a class="iq_link_1" href="demo-meeting-title/index.php">Read More</a>
                                        </div>
                                    </div>                                 
                                </div>
                            	<!--Heading Wrap Start-->
                ...
                <div class="row">
                    <div class="col-md-8">
                    	<div class="iq_knowledge_des">
                            ...
                            <!--Heading Wrap End-->
                                <p>Demo Meeting description&hellip;</p>
                            <a class="iq_link_1" href="demo-meeting-title/index.php">Read More</a>
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <section class="iq_gallery_bg">
            ...
            <div class="load-more">
                <a class="iq_link_1" href="demo-meeting-title/index.php">LOAD MORE</a>
            </div>
        </section>  
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="iq_info_wrap">
                                <h5><a href="demo-meeting-title/index.php">Generic<br/>Notice</a></h5>
                            </div>
                        </li>
                        <li>
                            <i class=" fa fa-pencil-square-o"></i>
                            <div class="iq_info_wrap">
                                <h5><a href="demo-meeting-title/index.php">Examination<br/>Notice</a></h5>
                            </div>
                        </li>
                        <li>
                            <i class="fa fa-rupee"></i>
                           <div class="iq_info_wrap">
                                <h5><a href="demo-meeting-title/index.php">Tender/Quotation<br/>Notice</a></h5>
                            </div>
                        </li>
                    </ul>
                </div> 
