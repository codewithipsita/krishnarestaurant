...
<!-- Mirrored from lionsclubbls.org/our-events/?events_type=all by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:51:54 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<title>Welcome to the Official Website of Lions Club Balasore   |  Our Events</title>
...
<!--Meta OG properties-->
<meta property='og:title'  content="Welcome to the Official Website of Lions Club Balasore   |  Our Events"/>
...
<meta property="og:description" content="Welcome to the Official Website of Lions Club Balasore   |  Our Events"/>
...
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="../wp-json/oembed/1.0/embeda294.json?url=https%3A%2F%2Flionsclubbls.org%2Four-events%2F" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed9a7c?url=https%3A%2F%2Flionsclubbls.org%2Four-events%2F&amp;format=xml" />
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/82.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.html?rsd" />
...
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-267"><a href="#">Events</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-82 current_page_item menu-item-88"><a href="index.php" aria-current="page">Our Events</a></li>
...
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-267 parent"><a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="true">Events <i class="arrow fa fa-angle-right"></i></a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-82 current_page_item menu-item-88"><a href="index.php" aria-current="page">Our Events</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-268"><a href="../our-meetings/index.php">Our Meetings</a></li>
</ul>
...
<!--Header Wrap End-->
    ...
    <section id="content" class="ourevent-sec">
        <div class="container ftco-animate fadeInUp ftco-animated">
            <div class="row">
                <div class="col-md-12 col-lg-12 description">
                    ...
                    <article>
                            <section class="ispl-hero-wrap" style="background: -webkit-linear-gradient(to right, rgba(13,34,64,0.9) 0, rgba(13,34,64,0.1) 100%), url('../wp-content/uploads/2025/08/events-scaled-e1756491795902.jpg');background: linear-gradient(to right, rgba(13,34,64,0.9) 0, rgba(13,34,64,0.1) 100%), url('../wp-content/uploads/2025/08/events-scaled-e1756491795902.jpg'); ">
            ...
            <div class="ispl-hero-inner" style="position:relative; max-width:1120px; margin:0 auto; padding:6rem 1.25rem;">
                                    <h2 style="font-size:3rem; line-height:1.1; margin:0 0 1rem;">Celebrating Service, Inspiring Change –Our Events </h2>
                                                    <p style="font-size:1.125rem; max-width:800px;">“Every event of the Lions Club of Balasore is more than a gathering—it is a movement of compassion, unity, and purpose. Through our service programs, awareness campaigns, fundraisers, and community celebrations, we bring people together to create impact that lasts beyond the moment. Each event is an opportunity to serve, to learn, to lead, and to inspire others to join the journey of humanity. Whether it is a local outreach or a global initiative, our events shine as milestones of dedication, friendship, and hope. They remind us that when hearts unite in service, ordinary days turn into extraordinary memories, and together, we build a stronger, brighter tomorrow.”</p>
		...
		<style>
		/* Filter tabs */
		.events-filters { /*display:flex; gap:8px; flex-wrap:wrap;*/ text-align:center; margin:0 0 16px; }
		.events-filters a {
			display:inline-block; padding:8px 12px; border-radius:9px;
			border:1px solid #e0e0e0; text-decoration:none; font-weight:600; font-size:14px;margin:5px;
		}
		.events-filters a.is-active { background:#1976d2; color:#fff; border-color:#1976d2; }
		.events-filters a:hover { border-color:#9e9e9e; }

		/* Ribbon bookmark top-right */
		.event-card { position: relative; }
		.event-ribbon {
			position:absolute; top:10px; right:-8px;
			padding:6px 12px; color:#fff; font-weight:700; font-size:12px;
			border-top-left-radius:6px; border-bottom-left-radius:6px;
			box-shadow:0 2px 8px rgba(0,0,0,.15); z-index:2;
		}
		.event-ribbon.upcoming { background:#fb8c00; } /* orange */
		.event-ribbon.ongoing  { background:#2e7d32; } /* green */
		.event-ribbon.past     { background:#d32f2f; } /* red */

		.blog-entry .block-20 { display:block; background-size:cover; background-position:center; width:100%; aspect-ratio:2/3; }
		.events-pagination { display:flex; justify-content:center; margin:24px 0; }
		.events-pagination .page-numbers {
			display:inline-block; margin:0 4px; padding:8px 12px; border:1px solid #e0e0e0; border-radius:4px; text-decoration:none;
		}
		.events-pagination .page-numbers.current { border-color:#1976d2; background:#1976d2; color:#fff; }
		.events-pagination .page-numbers:hover { border-color:#9e9e9e; }
		</style>
		<div class="events-filters" role="tablist" aria-label="Filter events"><a class="is-active" href="indexc3df.html?events_type=all" role="tab" aria-selected="true">All</a><a class="" href="indexf3ab.html?events_type=past" role="tab" aria-selected="false">Past</a><a class="" href="index1cbd.html?events_type=ongoing" role="tab" aria-selected="false">Ongoing</a><a class="" href="index3c59.html?events_type=upcoming" role="tab" aria-selected="false">Upcoming</a></div>	<div class="row d-flex">
					<div class="col-md-6 col-lg-3 ftco-animate fadeInUp">
			<div class="blog-entry justify-content-end event-card">
									<span class="event-ribbon past">PAST</span>
								<a href="../event/sample-event-title1/index.php" class="block-20" style="background-image:url('../wp-content/uploads/2025/08/melvin-jones.jpg');"></a>
			...
			<div class="blog-entry justify-content-end event-card">
									<span class="event-ribbon past">PAST</span>
								<a href="../event/sample-event-title-1/index.php" class="block-20" style="background-image:url('../wp-content/uploads/2025/08/default-avatar-icon-of-social-media-user-vector.jpg');"></a>
				<div class="text mt-3 float-right d-block">
					<div class="d-flex align-items-center p-2 pr-3 mb-4 topp">
						<div class="one">
