...
<!-- Mirrored from lionsclubbls.org/impacts/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:51:58 GMT -->
...
<link rel="alternate" type="application/rss+xml" title="Lions Club Balasore &raquo; Impacts Feed" href="feed/index.php" />
...
<!-- end Home Slider -->
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-12 col-sm-12">
                                    	<div class="iq_professional_services principal">                                        	
                                            ...
                                            <a class="iq_link_1" href="impact-name-2/index.php">Read More</a>
                                        </div>
                                    </div>                                 
                                </div>
                            	<!--Heading Wrap Start-->
        ...
        <section class="iq_gallery_bg">
            ...
            <div class="load-more">
                <a class="iq_link_1" href="impact-name-1/index.php">LOAD MORE</a>
            </div>
        </section>  
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="iq_info_wrap">
                                <h5><a href="impact-name-1/index.php">Generic<br/>Notice</a></h5>
                            </div>
                        </li>
                        <li>
                            <i class=" fa fa-pencil-square-o"></i>
                            <div class="iq_info_wrap">
                                <h5><a href="impact-name-1/index.php">Examination<br/>Notice</a></h5>
                            </div>
                        </li>
                        <li>
                            <i class="fa fa-rupee"></i>
                           <div class="iq_info_wrap">
                                <h5><a href="impact-name-1/index.php">Tender/Quotation<br/>Notice</a></h5>
                            </div>
                        </li>
                    </ul>
                </div> 
