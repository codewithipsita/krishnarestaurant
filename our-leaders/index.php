...
<!-- Mirrored from lionsclubbls.org/our-leaders/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:50:31 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8">
<title>Welcome to the Official Website of Lions Club Balasore   |  Our Leaders</title>
...
<!--Meta OG properties-->
<meta property='og:title'  content="Welcome to the Official Website of Lions Club Balasore   |  Our Leaders"/>
...
<meta property="og:description" content="Welcome to the Official Website of Lions Club Balasore   |  Our Leaders"/>
...
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="../wp-json/oembed/1.0/embed38c8.json?url=https%3A%2F%2Flionsclubbls.org%2Four-leaders%2F" />
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="../wp-json/oembed/1.0/embed803c?url=https%3A%2F%2Flionsclubbls.org%2Four-leaders%2F&amp;format=xml" />
...
<link rel="https://api.w.org/" href="../wp-json/index.php" /><link rel="alternate" title="JSON" type="application/json" href="../wp-json/wp/v2/pages/204.json" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="../xmlrpc0db0.html?rsd" />
...
<style id="ispl-bm-grid-inline-css">

            .ispl-bm-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:16px}
            .ispl-bm-card{border:1px solid #e5e7eb;border-radius:14px;overflow:hidden;background:#fff;box-shadow:0 1px 2px rgba(0,0,0,.05)}
            .ispl-bm-photo img{width:100%;height:200px;object-fit:cover;display:block}
            .ispl-bm-body{padding:12px}.ispl-bm-name{font-weight:700;margin:0 0 4px}
            .ispl-bm-desig{font-size:.95em;color:#2563eb;margin:0 0 6px}
            .ispl-bm-year{font-size:.85em;color:#6b7280;margin-bottom:8px}
            .ispl-bm-desc{font-size:.95em;line-height:1.45}
            .ispl-bm-phone{margin-top:8px;font-weight:600}
        
/*# sourceURL=ispl-bm-grid-inline-css */
</style>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-204 current_page_item menu-item-has-children menu-item-206"><a href="index.php" aria-current="page">Our Leaders</a>
<ul class="sub-menu">
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-204 current_page_item menu-item-has-children menu-item-206 parent"><a href="index.php" aria-current="page" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="true">Our Leaders <i class="arrow fa fa-angle-right"></i></a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-442"><a href="../our-president/index.php">Our President</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-448"><a href="../name-of-charter-members/index.php">Name of Charter Members</a></li>
</ul>
        ...
        <div class="container ftco-animate fadeInUp ftco-animated">
            <div class="row">
                <div class="col-md-12 col-lg-12 description">
                    ...
                    <article>
                            <section class="ispl-hero-wrap" style="background: -webkit-linear-gradient(to right, rgba(13,34,64,0.9) 0, rgba(13,34,64,0.1) 100%), url('../wp-content/uploads/2025/08/bealion-2.jpg');background: linear-gradient(to right, rgba(13,34,64,0.9) 0, rgba(13,34,64,0.1) 100%), url('../wp-content/uploads/2025/08/bealion-2.jpg'); ">
            ...
            <div class="ispl-hero-inner" style="position:relative; max-width:1120px; margin:0 auto; padding:6rem 1.25rem;">
                                    <h2 style="font-size:3rem; line-height:1.1; margin:0 0 1rem;">We Lead by Example</h2>
                                                    <p style="font-size:1.125rem; max-width:800px;">As Lions, our actions and service inspires others. We provide courage and a unique sense of empowerment to our communities and to the world. To do this, we depend on great leadership. And that takes great leadership development for our members.</p>
                                                    <p style="margin-top:2rem;">
                        <a href="../join-now/index.php" class="ispl-hero-btn" style="display:inline-block; padding:.9rem 1.5rem; background:#ffcc00; color:#111; text-decoration:none; border-radius:.35rem; font-weight:600;">
                            Join Now                        </a>
                    </p>
                            </div>
        </section>
        
<div class="ispl-bm-grid"><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Shiv Kumar Poddar</h3><div class="ispl-bm-desig">President</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Shri Bhagwan Gupta</h3><div class="ispl-bm-desig">IPP</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Rajendra Kumar Gupta</h3><div class="ispl-bm-desig">1st V.P</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Rajendra Mahawar</h3><div class="ispl-bm-desig">2nd V.P</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Bishnu Maroo</h3><div class="ispl-bm-desig">Secretary</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Nitin Sharma</h3><div class="ispl-bm-desig">Joint Secretary</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Shyam Sundar Khandelwal</h3><div class="ispl-bm-desig">Treasurer</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Chandra Prakash Bhartia</h3><div class="ispl-bm-desig">Club LCIF Co-ordinator</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Sanjay Das</h3><div class="ispl-bm-desig">Club Marketing Chairperson</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Rajesh Kumar Khandelwal</h3><div class="ispl-bm-desig">Club Service Chairperson</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Tushar Doshi</h3><div class="ispl-bm-desig">Club Membership Chairperson</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Sunil Kumar Modi</h3><div class="ispl-bm-desig">Lion Quest Co-ordinator</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Adarsh Bhatter</h3><div class="ispl-bm-desig">Club PRO</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Kamal Modi</h3><div class="ispl-bm-desig">Tail Twister</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article><article class="ispl-bm-card"><div class="ispl-bm-photo"></div><div class="ispl-bm-body"><h3 class="ispl-bm-name">Ln. Chirag Chauhan</h3><div class="ispl-bm-desig">Tail Temor</div><div class="ispl-bm-year"> LY-2025-2026</div><div class="ispl-bm-desc"></div></div></article></div>
                                        </article>
...
<!-- Mirrored from lionsclubbls.org/our-leaders/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 08:50:32 GMT -->
</html>